document.addEventListener("DOMContentLoaded", function () {
  ...
  console.log("techTip:", techTip);
  console.log("robotTipImage:", robotTipImage);
  ...
  function showRandomTip() {
    ...
    console.log("Robot was clicked. Tip changed.");
  }

  if (techTip && robotTipImage) {
    robotTipImage.addEventListener("click", showRandomTip);
  } else {
    console.log("Problem: techTip or robotTipImage was not found.");
  }
});
